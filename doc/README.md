...
| [0055](decisions/0055-absence-chooses-the-store.md) | **Absence chooses the store, and it chooses nothing for the tests** | accepted; builds on 0003, which is no longer the only store; settles the `TEST_` pair for 1.0 |
