...
| [`design/the-pipeline.md`](design/the-pipeline.md) | **The ten-step pipeline, whole: the design, the roadmap and the tickets.** What changes, the 2961-line obstacle in the way of it, six phases and seventeen tickets with their evidence and their traps, and what is true when it is done. Implements 0058, 0060 and 0061. |
