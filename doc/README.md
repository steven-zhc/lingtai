...
| [0050](decisions/0050-a-version-is-a-directory.md) | **A version is a directory, and the shim is the only thing that moves** | accepted; the installer, upgrade, rollback and uninstall (#184) |
