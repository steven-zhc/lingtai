...
| [0045](decisions/0045-a-signal-does-not-outlive-its-daemon.md) | **A signal does not outlive its daemon, so a restart is `shutdown` and then `start`** | accepted; supersedes 0030 §2 in part and 0042 §7; closes #159 |
